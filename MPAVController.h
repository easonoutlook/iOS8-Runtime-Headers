...
@class MPMediaQuery, MPAVItem, NSMutableSet, MPMediaItem, MPAVRoutingController, NSString, MPQueuePlayer, MPQueueFeeder, NSMutableArray, NSNotification, MPAVPlaylistManager, CALayer, AVAudioSessionMediaPlayerOnly, MPAVRoute, NSDate, MPAVErrorResolver, NSObject<OS_dispatch_source>, NSArray, AVPlayerLayer, MPVideoView, MPAVControllerToAggregateDCommunicator;
