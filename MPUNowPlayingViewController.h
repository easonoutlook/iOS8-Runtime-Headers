...
@class MPURatingControl, MPUNowPlayingPlaybackControlsView, MPUNowPlayingTitlesView, MPAVItem, MPAVController, MPNowPlayingObserver, UIView, UIViewController, UINavigationBar, UITapGestureRecognizer, MPULyricsView, MPUApplicationDefaults, UINavigationItem;

@interface MPUNowPlayingViewController : UIViewController <MPURatingControlDelegate, UIGestureRecognizerDelegate, MPTransportControlsTarget, MPUNowPlayingPlaybackControlsViewDelegate> {
