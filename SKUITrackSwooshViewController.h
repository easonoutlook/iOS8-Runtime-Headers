...
@class SKUITrackSwooshCollectionViewLayout, NSObject<OS_dispatch_source>, <SKUITrackSwooshViewControllerDelegate>, UICollectionView, SKUISwooshPageComponent, SKUISwooshView, SKUIItemOfferButtonAppearance, NSArray;
