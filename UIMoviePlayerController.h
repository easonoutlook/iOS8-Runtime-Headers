...
@class UIImage, <MPVideoControllerProtocol>, MPAVItem, MPAVController, MPVideoView, MPNowPlayingObserver, NSDate, UIView, UINavigationController, NSArray, MPTransitionController, UIViewController, _UIHostedWindow, MPMovieAccessLog, NSString, UIMovieView, MPMovieErrorLog;
