...
@interface SKSequence : SKAction  {
  ...
  /* Error parsing encoded ivar type info: ^{SKCSequence=^^?If@BddffdBB@?iffff{vector<SKCAction *, std::__1::allocator<SKCAction *> >=^^{SKCAction}^^{SKCAction}{__compressed_pair<SKCAction **, std::__1::allocator<SKCAction *> >=^^{SKCAction}}}L} */
    struct SKCSequence { int (**x1)(); unsigned int x2; float x3; id x4; boolx5; double x6; double x7; float x8; float x9; double x10; boolx11; boolx12; id x13; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x14; int x15; float x16; float x17; float x18; float x19; struct vector<SKCAction *, std::__1::allocator<SKCAction *> > { struct SKCAction {} **x_20_1_1; struct SKCAction {} **x_20_1_2; struct __compressed_pair<SKCAction **, std::__1::allocator<SKCAction *> > { struct SKCAction {} **x_3_2_1; } x_20_1_3; } x20; unsigned long x21; } *_mycaction;
