...
@class NSSet, NSNumber, NSObject<OS_dispatch_queue>, NSOrderedSet, NSDate, NSDictionary, NSMutableSet, NSString, NSMutableDictionary, NSArray;
...
@property(retain) NSOrderedSet * zoomPreferredLensEffects;
...
- (void)setZoomPreferredLensEffects:(id)arg1;
