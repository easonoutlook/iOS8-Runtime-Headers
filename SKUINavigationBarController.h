...
@class SKUINavigationPaletteController, SKUIClientContext, SKUINavigationBarViewElement, NSMapTable, NSMutableArray, SKUINavigationBarButtonsController, UIView, UIViewController, SKUINavigationBarContext;
