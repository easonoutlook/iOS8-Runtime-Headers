...
@class UIStatusBarStyleAnimationParameters, UIColor, NSNumber, UIStatusBarBackgroundView, UILabel, UIStatusBarForegroundView, <UIStatusBarStateProvider>, UIStatusBar, <UIStatusBarStyleDelegate>, NSMutableSet, UIView, UIStatusBarServer, UIStatusBarStyleRequest, UIStatusBarWindow, NSString, NSMutableArray, UIStatusBarStyleAttributes;
