...
@class IMHandle, NSNumber, IMAccount, NSData, IMPair, IMAVChatParticipant, NSError, IMTimingCollection, NSDate, NSDictionary, NSObject<OS_dispatch_queue>, NSArray, NSString, NSMutableDictionary, NSMutableArray, NSTimer;
