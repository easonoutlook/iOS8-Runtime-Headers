...
@class MFComposeRecipient, <MFComposeRecipientViewDelegate>, UITextField, UIFont, UIButton, NSCountedSet, _MFMailRecipientTextField, MFModernComposeRecipientAtom, UIView, MFCorecipientsIndicatorAtom, NSArray, UITapGestureRecognizer, NSString, NSMutableDictionary, NSMutableArray, NSTimer;
