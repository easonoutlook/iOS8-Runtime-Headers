...
@class NSAttributedString, UIGestureRecognizer, UIImage, UIToolbar, NSMutableIndexSet, UILabel, UITableView, UIView, UIPopoverController, UIWindow, <UIActionSheetDelegate>, NSString, NSMutableArray, UIImageView;
