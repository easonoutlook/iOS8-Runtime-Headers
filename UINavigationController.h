...
@class _UINavigationInteractiveTransition, _UIAnimationCoordinator, UIGestureRecognizer, _UIBarTapGestureRecognizer, _UINavigationControllerPalette, NSUUID, NSString, _UINavigationParallaxTransition, UITapGestureRecognizer, UINavigationTransitionView, UIViewController, _UIBarPanGestureRecognizer, UIToolbar, UIPanGestureRecognizer, <UINavigationControllerDelegate>, UINavigationBar, NSArray, <UIViewControllerAnimatedTransitioning>, <UIViewControllerInteractiveTransitioning>, UIView;
...
@interface UINavigationController : UIViewController <UIGestureRecognizerDelegatePrivate, UINavigationBarDelegate, GKContentRefresh, GKURLHandling> {
    ...
    BOOL _condensesBarsWhenKeyboardAppears;
    BOOL _condensesBarsOnSwipe;
...
- (void)MPU_popToViewController:(id)arg1 animated:(BOOL)arg2;
