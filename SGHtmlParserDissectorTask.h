...
@class NSMutableString, NSData, NSMutableArray, NSMutableIndexSet;
...
@interface SGHtmlParserDissectorTask : NSObject  {
    ...
    int _blockquoteLevel;
    unsigned int _startOfCurrentQuotedRegion;
...
- (void)addQuotedRegionFrom:(unsigned int)arg1 to:(unsigned int)arg2;
