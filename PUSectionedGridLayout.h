...
@class PUSectionedGridLayoutInvalidationContext, UICollectionViewLayout, NSIndexSet, UICollectionViewLayoutAttributes, PULayoutAnimationsHelper, NSPointerArray, NSSet, NSDictionary, <PUCollectionViewLayoutTransitioningDelegate>, NSArray, <PUSectionedGridLayoutDelegate>, PULayoutSampledSectioning, NSString, NSIndexPath;
