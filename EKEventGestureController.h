...
@class EKDayOccurrenceView, <EKEventGestureControllerUntimedDelegate>, UILongPressGestureRecognizer, EKCalendarDate, NSTimer, NSString, <EKEventGestureControllerDelegate>, EKEvent;
