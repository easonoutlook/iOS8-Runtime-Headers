...
@class UITransitionView, PHAssetCollection, PLPhotoScrubber, PLVideoView, PLAirPlaySession, UIPageController, NSIndexPath, PLDeletePhotosActionController, <PLRootLibraryNavigationController>, NSString, NSNumberFormatter, UIAlertView, UILongPressGestureRecognizer, PLVideoRemaker, UINavigationBar, UIWindow, UIScrollView, UIView, PLAssetContainerDataSource, NSArray, UIImage, PLPictureFramePlugin, PLAirPlayBackgroundView, PHAsset, PLEditPhotoController, NSMutableArray, PHCachingImageManager, PLProgressView, NSTimer, <PLPhotoBrowserControllerDelegate>, PLProgressHUD, NSManagedObjectID, UIActionSheet, PHFetchResult, PLPhotoTileViewController, NSMutableDictionary, NSDictionary;
...
- (unsigned int)allowedDeleteOperationForAsset:(id)arg1;
