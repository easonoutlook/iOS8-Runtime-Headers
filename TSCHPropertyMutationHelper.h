...
+ (id)commandWithStyleOwner:(id)arg1 mutationsMap:(id)arg2 allowSpecificProperties:(BOOL)arg3;
+ (id)commandWithStyleOwner:(id)arg1 mutations:(id)arg2 allowSpecificProperties:(BOOL)arg3;
...
+ (id)commandWithMutationTuples:(id)arg1 allowSpecificProperties:(BOOL)arg2;
