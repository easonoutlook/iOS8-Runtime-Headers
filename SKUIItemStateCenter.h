...
@class NSCountedSet, NSObject<OS_dispatch_queue>, SSDownloadManager, NSHashTable, NSMutableArray, SSAppPurchaseHistoryDatabase, SSSoftwareUpdatesStore, NSMutableDictionary;
