...
@class TSPObjectContainer, NSMutableArray, TSPComponentExternalReferenceMap, TSPPackageMetadata, TSUPathSet, TSPObjectContext, TSPDocumentRevision, NSObject<OS_dispatch_queue>, NSObject<OS_dispatch_group>, NSHashTable, TSPArchiverManager, NSURL;
...
- (id)initWithContext:(id)arg1 documentRevision:(id)arg2 saveToken:(unsigned long long)arg3 packageIdentifier:(unsigned char)arg4 fileFormatVersion:(unsigned long long)arg5 packageWriteCoordinator:(id)arg6 captureSnapshots:(BOOL)arg7;
...
- (id)initWithContext:(id)arg1 documentRevision:(id)arg2 saveToken:(unsigned long long)arg3 packageIdentifier:(unsigned char)arg4 fileFormatVersion:(unsigned long long)arg5;
