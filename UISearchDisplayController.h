...
@class UINavigationItem, UIColor, <UISearchDisplayDelegate>, UILabel, UIScrollView, UITableView, UIButton, UISearchDisplayControllerContainerView, UIView, UIViewController, NSArray, <UITableViewDelegate>, UIPopoverController, _UINavigationControllerPalette, _UISearchControllerDidScrollDelegate, NSString, <UITableViewDataSource>, UISearchBar;
