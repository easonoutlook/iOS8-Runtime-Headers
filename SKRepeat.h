...
@interface SKRepeat : SKAction  {
  ...
  /* Error parsing encoded ivar type info: ^{SKCRepeat=^^?If@BddffdBB@?iffff^{SKCAction}IIc} */
    struct SKCRepeat { int (**x1)(); unsigned int x2; float x3; id x4; boolx5; double x6; double x7; float x8; float x9; double x10; boolx11; boolx12; id x13; /* Warning: Unrecognized filer type: '?' using 'void*' */ void*x14; int x15; float x16; float x17; float x18; float x19; struct SKCAction {} *x20; unsigned int x21; unsigned int x22; BOOL x23; } *_mycaction;
