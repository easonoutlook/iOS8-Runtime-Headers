...
@class UIInputViewPostPinningReloadState, NSMutableDictionary, UIKeyboardRotationState, UIPeripheralHostView, UITextEffectsWindow, UIScrollView, UIPeripheralHostState, NSMutableSet, UIKeyboardAutomatic, UIView, UIInputViewTransition, CADisplayLink, UIKeyboard, UIInputViewSet, UIPanGestureRecognizer, UIResponder, NSMutableArray;
