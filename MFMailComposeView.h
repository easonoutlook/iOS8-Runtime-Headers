...
@class MFComposeMultiView, NSInvocation, UIPickerView, MFComposeBodyField, MFComposeFromView, <MFMailPopoverManagerDelegate>, MFComposeScrollView, <MFComposeRecipientTextViewDelegate>, UITableView, <MFMailComposeViewDelegate>, MFMailComposeRecipientView, MFComposeImageSizeView, <MFMailComposeToFieldDelegate>, MFFromAddressViewController, MFComposeTextContentView, MFMailComposeContactsSearchController, MFSearchResultsViewController, NSArray, UIResponder, MFComposeSubjectView, UIView;
