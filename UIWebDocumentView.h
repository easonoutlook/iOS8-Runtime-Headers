...
@class NSDictionary, UITextRange, _UIWebViewportHandler, WebHistoryItem, UIWebFileUploadPanel, NSString, _UIWebHighlightLongPressGestureRecognizer, NSTimer, UITapGestureRecognizer, DOMRange, UIAutoscroll, _UITextServiceSession, UITextInteractionAssistant, DOMHTMLElement, CALayer, UILongPressGestureRecognizer, UITextPosition, WebView, UIWebSelectionAssistant, DOMNode, UITextInputTraits, <UITextInputDelegate>, UIPanGestureRecognizer, UIWebPlaybackTargetPicker, WebThreadSafeUndoManager, NSArray, UIWebRotatingSheet, <UITextInputTokenizer>, UITextChecker, UIColor, UIImage, UIView;
