...
@class UIImage, NSAttributedString, UIColor, UILabel, UIFont, UIView, _UIButtonMaskAnimationView, NSArray, NSDictionary, UITapGestureRecognizer, NSString, UIImageView;
