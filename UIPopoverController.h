...
@class UIPanGestureRecognizer, NSArray, UIPopoverPresentationController, _UIPopoverView, <UIPopoverControllerDelegate>, UIView, UIBarButtonItem, UIViewController, _UIPopoverLayoutInfo, UIDimmingView, UIColor;
