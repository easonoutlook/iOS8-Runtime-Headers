...
@class NSMutableArray, ACIDSProxy, ACDDataclassOwnersManager, ACDClientAuthorizationManager, ACDFakeRemoteAccountStoreSession, <ACDAccountStoreDelegate>, ACDClient, ACDAuthenticationPluginManager, ACDAuthenticationDialogManager, ACDAccessPluginManager, ACDAccountStoreFilter, ACDDatabase;
