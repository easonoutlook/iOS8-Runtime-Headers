...
@class SKUIItemStateCenter, NSOperationQueue, UIImageView, SKUITextBoxView, UIButton, SKUIGiftItemView, UIImage, SKUITextLayout, SKUIRedeemResultMessageView, SKUIRedeemITunesPassLockup, SKUIRedeem;
