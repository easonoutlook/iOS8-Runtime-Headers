...
- (void)copyFromTexture:(id)arg1 sourceSlice:(unsigned int)arg2 sourceLevel:(unsigned int)arg3 sourceOrigin:(struct { unsigned int x1; unsigned int x2; unsigned int x3; })arg4 sourceSize:(struct { unsigned int x1; unsigned int x2; unsigned int x3; })arg5 toBuffer:(id)arg6 destinationOffset:(unsigned int)arg7 destinationRowBytes:(unsigned int)arg8 destinationImageBytes:(unsigned int)arg9;
- (void)copyFromBuffer:(id)arg1 sourceOffset:(unsigned int)arg2 sourceRowBytes:(unsigned int)arg3 sourceImageBytes:(unsigned int)arg4 sourceSize:(struct { unsigned int x1; unsigned int x2; unsigned int x3; })arg5 toTexture:(id)arg6 destinationSlice:(unsigned int)arg7 destinationLevel:(unsigned int)arg8 destinationOrigin:(struct { unsigned int x1; unsigned int x2; unsigned int x3; })arg9;
