...
@class UITextPosition, UIColor, UIImage, UITextRange, DOMNode, DOMDocument, DOMNamedNodeMap, UITextInteractionAssistant, <UITextInputDelegate>, UIResponder<UITextInput>, UIView, <UITextInputTokenizer>, NSDictionary, UIView<UITextInputPrivate>, WebArchive, DOMNodeList, DOMElement, NSString;
