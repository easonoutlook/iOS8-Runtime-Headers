...
@class CMAmbientPressureData, CMGyroData, CMMagnetometerData, CMDeviceMotion, CMAccelerometerData;
...
+ (void)initialize;
+ (BOOL)hasRunMiniCal;
+ (struct { struct { float x_1_1_1; float x_1_1_2; float x_1_1_3; } x1; struct { float x_2_1_1; float x_2_1_2; float x_2_1_3; } x2; })gyroCalibrationDatabaseGetBiasFit;
