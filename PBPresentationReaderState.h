...
@class NSMutableArray, PBOutlineBulletDictionary, PDPresentation, PDSlideBase, PBOfficeArtReaderState, ESDObject, PBSlideState, ESDRoot, <TCCancelDelegate>, NSMutableDictionary, OITSUNoCopyDictionary, ESDContainer;
