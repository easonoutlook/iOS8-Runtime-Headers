...
@class MPInlineVideoController, <MPMoviePlayerControllerDelegate>, NSError, MPAVController, MPNowPlayingObserver, NSMutableSet, MPMoviePlayerController, MPMovieErrorLog, NSDictionary, NSArray, UIWindow, MPMovieView, MPMovieAccessLog, NSMutableDictionary, NSMutableArray;
