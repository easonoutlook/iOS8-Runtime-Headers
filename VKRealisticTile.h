...
@class VKAnimation, NSArray, VKRealisticPolygonMaker, NSMutableArray, NSMapTable;
...
@property(readonly) struct fast_shared_ptr<ggl::Texture2D> { struct _fast_shared_ptr_control {} *x1; } defaultLandTexture;
@property(readonly) struct fast_shared_ptr<ggl::Texture2D> { struct _fast_shared_ptr_control {} *x1; } defaultLandTextureVariant;
...
- (struct fast_shared_ptr<ggl::Texture2D> { struct _fast_shared_ptr_control {} *x1; })defaultLandTexture;
- (struct fast_shared_ptr<ggl::Texture2D> { struct _fast_shared_ptr_control {} *x1; })defaultLandTextureVariant;
- (void)updateTextures;
