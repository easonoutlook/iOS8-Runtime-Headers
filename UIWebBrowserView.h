...
@class NSMutableArray, DOMNode, NSObject<UIFormPeripheral>, NSTimer, <UIWebAutoFillDelegate>, UIWebFormDelegate, NSLock, NSMutableSet, UIWebPDFView, UIWebFormAccessory, UIView, NSHashTable, NSString, UIResponder, UIWebTouchEventsGestureRecognizer;
