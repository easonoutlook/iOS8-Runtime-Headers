...
@class _UIFlowLayoutInfo, NSMutableSet, NSArray, NSDictionary, NSMutableArray;
...
- (void)computeLayout;
- (void)computeLayoutInRect:(struct CGRect { struct CGPoint { float x_1_1_1; float x_1_1_2; } x1; struct CGSize { float x_2_1_1; float x_2_1_2; } x2; })arg1 forSection:(int)arg2;
