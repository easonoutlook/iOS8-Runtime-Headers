...
@class <NDBackgroundSessionProtocol>, NSObject<OS_dispatch_queue>, NSMutableArray, NSString, NSURL, NSMutableDictionary, NSXPCConnection;
...
- (void)willRetryBackgroundDataTask:(unsigned int)arg1;
...
- (void)backgroundTask:(unsigned int)arg1 willPerformHTTPRedirectionWithNewRequest:(id)arg2;
