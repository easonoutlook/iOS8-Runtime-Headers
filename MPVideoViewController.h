...
@class UIImage, UIColor, UIAlertView, MPAVItem, MPAVController, UIActivityIndicatorView, MPVideoView, MPVideoBackgroundView, UIView, MPSwipableView, MPClosedCaptionDisplay, UIView<MPVideoOverlay>, _UIHostedWindow, MPTVOutWindow;
