...
@class KeychainSyncSecurityCodeController, KeychainSyncDevicePINController, UIAlertView, PSRootController, UIView, UIViewController, KeychainSyncAdvancedSecurityCodeController, KeychainSyncPhoneNumberController, KeychainSyncSMSVerificationController, NSString, PSSetupController, NSTimer;
