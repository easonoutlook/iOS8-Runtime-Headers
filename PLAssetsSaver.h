...
- (void)requestAsynchronousImageForAssetOID:(id)arg1 withFormat:(int)arg2 wantURLOnly:(BOOL)arg3 networkAccessAllowed:(BOOL)arg4 trackCPLDownload:(BOOL)arg5 completionBlock:(id)arg6;
- (id)requestSynchronousImageForAssetOID:(id)arg1 withFormat:(int)arg2 wantURLOnly:(BOOL)arg3 networkAccessAllowed:(BOOL)arg4 trackCPLDownload:(BOOL)arg5 outImageDataInfo:(id*)arg6 outCPLDownloadContext:(id*)arg7;
