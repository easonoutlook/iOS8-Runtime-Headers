...
@class SKUIStyledImageView, SKUILockupViewElement, SKUISizeValue, UIView, NSMapTable;
...
+ (float)_lineSpacingForViewElement:(id)arg1 width:(float)arg2 context:(id)arg3;
