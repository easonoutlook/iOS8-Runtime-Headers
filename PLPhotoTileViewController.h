...
@class UIImage, NSObject<OS_dispatch_source>, UIGestureRecognizer, PLExpandableImageView, UIView<PLTilePlaceholderView>, PLPhotoTileBadgeView, PLTileContainerView, <PLPhotoTileViewControllerDelegate>, PLImageScrollView, PHAsset, PHCachingImageManager, PLCommentsViewController, PLVideoView, UIImageView;
...
@interface PLPhotoTileViewController : UIViewController <UIScrollViewDelegate, UIGestureRecognizerDelegate, PLCommentsViewControllerDelegate, PLPhotoTileCloudPlaceholderViewDelegate> {
  ...
  /* Error parsing encoded ivar type info: @? */
    ...
    unsigned int _fullSizeImageRequestID;
