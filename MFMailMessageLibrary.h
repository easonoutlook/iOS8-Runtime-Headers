...
@class MFMailMessageLibraryMigrator, NSObject<OS_dispatch_queue>, MFDbJournal, <MFMailMessageLibraryDelegate>, <MFMailboxPathProvider>, MFSQLiteConnectionPool, MFLibraryContentIndex, NSString, MFWeakObjectCache, NSMutableSet;
