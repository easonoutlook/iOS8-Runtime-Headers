...
@class NSURL, SSMetricsPageEvent, NSHTTPURLResponse, NSMutableData, NSURLRequest, NSData, NSMutableSet, NSObject<OS_dispatch_queue>, SSVURLDataConsumer, NSString, NSRunLoop, NSCachedURLResponse;
