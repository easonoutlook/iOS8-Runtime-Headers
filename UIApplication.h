...
@class NSMutableDictionary, UIColor, UIApplicationSceneSettingsDiffInspector, <UIApplicationDelegate>, UIEvent, UIAlertView, UIStatusBar, UIPhysicalButtonsEvent, NSMutableSet, UIWheelEvent, UIPhysicalKeyboardEvent, NSArray, UIWindow, UIMoveEvent, UIStatusBarWindow, NSString, NSMutableArray, NSTimer;
...
- (void)_invalidateActivityContinuation:(id)arg1;
- (id)_saveActivityContinuationFromDictionary:(id)arg1 currentActivity:(id)arg2;
...
- (id)_buildActivityContinuationDictionary:(id)arg1 activityType:(id)arg2;
- (id)_activityContinuationDictionary;
- (id)_buildActivityContinuationDictionaryLegacySPI:(id)arg1;
- (id)_reallyBuildActivityContinuationDictionary:(id)arg1 activityType:(id)arg2;
- (id)_activityContinuationDictionaryFromActivityUUID:(id)arg1;
...
- (void)_handleActivityContinuationLegacy:(id)arg1;
- (void)_handleActivityContinuationNew:(id)arg1;
...
- (id)_saveActivityContinuationFromDictionary:(id)arg1 currentActivity:(id)arg2 typeIdentifier:(id)arg3;
- (void)_saveActivityContinuationPlistFromDictionary:(id)arg1;
- (id)_urlForActivityContinuation;
...
- (id)_getActivityContinuationDictionaryFromPayloadIfPresent:(id)arg1;
