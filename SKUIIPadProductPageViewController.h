...
@class SKUINetworkErrorViewController, SKUISwooshArrayViewController, ACAccountStore, NSString, SKUIProductPageReviewsViewController, SKUIProductPageHeaderViewController, SSMetricsPageEvent, NSURLRequest, SKUIProductPage, SKUIItem, SKUIAskPermissionBanner, <SKUIIPadProductPageDelegate>, SKUIProductPageDetailsViewController, SKUIIncompatibleAppViewController, SKUIClientContext, SKUIFacebookLikeStatus, SKUIMetricsController, SKUILoadProductPageOperation, SKUIProductPagePlaceholderViewController, NSOperationQueue, UIView, NSURL;

@interface SKUIIPadProductPageViewController : UIViewController <SKUIMetricsViewController, SKUINetworkErrorDelegate, SKUIProductPageHeaderViewDelegate, SKUIProductPageChildViewControllerDelegate, SKUIAskPermissionBannerDelegate> {
