...
@class MPWeakTimer, MPVideoView, MPAVItem, _UIHostedWindow, UIView<MPVideoOverlay>, NSString, UIAlertView, MPVideoBackgroundView, MPAudioVideoRoutingPopoverController, MPVideoContainerView, MPAVController, MPSwipableView, UITapGestureRecognizer, MPInlineAudioOverlay, MPInlineVideoFullscreenViewController, MPTVOutWindow, UIActivityIndicatorView, NSSet, UIWindow, MPVideoPlaybackOverlayView, UIPinchGestureRecognizer, UIImage, UIColor, MPVolumeController, UIView, UINavigationController;
