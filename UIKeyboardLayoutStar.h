...
@class UIKBRenderConfig, UIKeyboardSplitTransitionView, UIDelayedAction, UISwipeGestureRecognizer, UIKBBackgroundView, NSMutableSet, UIView, UIKBKeyplaneView, UIKBTree, UIKeyboardKeyplaneTransition, CADisplayLink, NSString, NSMutableDictionary, NSTimer;
...
+ (float)defaultKeyHeightWithScreenTriats:(id)arg1;
