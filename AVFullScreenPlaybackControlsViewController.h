...
@class AVLoadingIndicatorView, NSLayoutConstraint, UILabel, MPVolumeController, UIButton, UIView, NSArray, MPVolumeSlider, NSString, AVScrubber, NSMutableArray, NSTimer;
