...
@interface PLBBMav10HwMsgParser : PLMav7BasebandHardwareMessage  {
    ...
    struct { unsigned short x1; unsigned int x2; unsigned int x3; int x4; unsigned short x5[4][6]; unsigned int x6[4][6]; } *_rfOOS;
...
@property struct { unsigned short x1; unsigned int x2; unsigned int x3; int x4; unsigned short x5[4][6]; unsigned int x6[4][6]; }* rfOOS;
...
- (struct { unsigned short x1; unsigned int x2; unsigned int x3; int x4; unsigned short x5[4][6]; unsigned int x6[4][6]; }*)rfOOS;
...
- (void)setRfOOS:(struct { unsigned short x1; unsigned int x2; unsigned int x3; int x4; unsigned short x5[4][6]; unsigned int x6[4][6]; }*)arg1;
