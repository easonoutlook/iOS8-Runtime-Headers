...
@class SLPlace, SLMicroBlogMentionsViewController, SLMicroBlogAccountsTableViewController, SLMicroBlogUserRecord, SLComposeSheetConfigurationItem, NSString, SLSheetPlaceViewController, NSObject<SLMicroBlogSheetDelegate>, NSArray;
