...
@class CKContainerID, NSOperationQueue, CKDatabase, CKAccountInfo, CKRecordID, CKOperationCallbackManager, ACAccountStore, NSString, CKOperationFlowControlManager, NSXPCConnection;
