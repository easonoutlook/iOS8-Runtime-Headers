...
@class UIImage, UIColor, UINavigationItem, UISwipeGestureRecognizer, _UIViewControllerTransitionContext, UIView, NSDictionary, NSArray, <UINavigationBarDelegate>, NSString, UIImageView, NSMutableArray;
